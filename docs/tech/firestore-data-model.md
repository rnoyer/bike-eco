...
- **B2C is email-only:** the public (non-logged-in) B2C funnel does **not** write
  ...
  summary emails routed NORTH/SOUTH (→ `rnoyer.dev@gmail.com` in dev). Because
