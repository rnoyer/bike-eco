...
✔  functions[us-central1-sendB2cSubmission]: http function initialized
   (http://127.0.0.1:5001/bike-eco-641ed/us-central1/sendB2cSubmission).
```
...
JSON
curl -s -w "\nHTTP %{http_code}\n" \
  -X POST "http://127.0.0.1:5001/bike-eco-641ed/us-central1/sendB2cSubmission" \
...
```bash
EXPO_PUBLIC_FUNCTIONS_URL=http://192.168.1.x:5001/bike-eco-641ed/us-central1 npx expo start
```
