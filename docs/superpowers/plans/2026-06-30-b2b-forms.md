...
export const B2B_SUBMISSION_STEPS: B2bStep[] = [
  ...
  { progress: 30, title: "Informations véhicule", subtitle: "Quelles clés avez-vous?", fields: ["aClesContact", "cleNoire", "cleMarron", "cleRouge", "aTelecommande", "telecommande"], render: () => <ClesFields /> },
